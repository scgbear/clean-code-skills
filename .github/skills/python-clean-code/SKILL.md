...
# Python Clean Code — Boy Scout Rule
...
2. Then make at least one small, proportional improvement:
   - **Quick wins:** rename an unclear variable (N1), delete a redundant comment (C3),
     remove dead code / unused imports (G9, P1), replace a magic number with a named
...
✅ Descriptive function name (N1) · clear parameter names (N1) · type hints (P3) ·
named constant (G25) · no output-argument mutation (F2) · useful docstring (C4)
