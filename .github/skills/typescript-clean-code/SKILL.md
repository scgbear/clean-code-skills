...
# TypeScript Clean Code — Boy Scout Rule
...
2. Then make at least one small, proportional improvement:
   - **Quick wins:** rename an unclear variable (N1), delete a redundant comment (C3),
     remove dead code / unused imports (G9, TS1), replace a magic number with a named
...
- ✅ Useful TSDoc documentation (C4)

---

## Clean Code Catalog — report violations by rule ID
